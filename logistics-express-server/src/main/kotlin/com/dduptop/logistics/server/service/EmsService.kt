...
import com.dduptop.logistics.server.model.request.xml.OrderCreateRequest
...
interface EmsService {
    ...
    fun createOrder(createRequest: OrderCreateRequest): XmlResponses<OrderCreateResponse>
